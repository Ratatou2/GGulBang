            ...
            <div class="private2022">
              <div class="inner-wrap">
                <div class="packageArea">
                  ...
                  <div class="pg_text">현재 보고 있는 매물의 상세 정보입니다</div>
                  <div class="packageBox act" id="packageBox">
                    <!-- for문 반복 -->
                    <div class="itemWrap">
                      <div class="basket-item item_custom" @click="houseStore.moveDetail(house.aptCode)">
                        <label :for="house.aptCode">
                          <div class="img">
                            <img src="@/assets/static/pc/images/reserve/private2022_3.png" alt="집집집" />
                          </div>
                          <div class="food-info">
                            <div class="name-area">
                            ...
                            <ul>
                              ...
                              <li>도로명 지하 부호: {{ house.roadNameBasementCode }}</li>
                ...
                />
                <!-- 구매 button -->
                <button @click="houseStore.buyHouse(userId, house.aptCode, house.ownerId)">구매</button>
              </div>
            </div>
          </div>
        </div>
...
/* KakaoMap 컴포넌트 스타일링 */
.kakao-map {
  width: 900px; /* 가로 크기 조절 */
  height: 600px; /* 세로 크기 조절 */
}
...
.private2022 .packageArea .packageBox .itemWrap .item_custom input:checked + label:after {
  background: url(https://img.megabox.co.kr/static/pc/images/reserve/checkbox_on.png) no-repeat;
  background-size: 28px 28px;
}
...
.private2022 .packageArea .packageBox .itemWrap .item_custom .food-info .name-area {
  position: relative;
  border-bottom: 1px solid #e4e4e4;
  letter-spacing: -0.01em;
}
.private2022 .packageArea .packageBox .itemWrap .item_custom .food-info .name-area .name {
  padding: 23px 0 19px;
  font-size: 18px;
  line-height: 21px;
}
.private2022 .packageArea .packageBox .itemWrap .item_custom .food-info .name-area .price {
  position: absolute;
  top: 5px;
  right: 16px;
}
.private2022 .packageArea .packageBox .itemWrap .item_custom .food-info .name-area .price em {
  display: inline-block;
  line-height: 55px;
  font-family: Roboto;
  font-weight: 400;
...
.private2022 .packageArea .packageBox .itemWrap .item_custom .food-info .name-area .price span {
  display: inline-block;
  line-height: 53px;
  padding: 2px 0 0 0;
  font-size: 1.3333em;
...
.private2022 .packageArea .packageBox .itemWrap .item_custom .food-info .dot_list {
  display: flex;
  flex-wrap: wrap;
  padding: 8px 0 20px;
}
.private2022 .packageArea .packageBox .itemWrap .item_custom .food-info .dot_list li {
  width: 50%;
}
.private2022 .packageArea .packageBox .itemWrap .item_custom .food-info .dot_list li:after {
  background-color: #aaa;
}
.private2022 .packageArea .packageBox .itemWrap .item_custom .food-info .dot_list li:first-child {
  padding-top: 8px;
}
.private2022 .packageArea .packageBox .itemWrap .item_custom .food-info .dot_list li:first-child:after {
  top: 13px;
}
.private2022 .packageArea .packageBox .itemWrap .item_custom .food-info .dot_list li.none:after {
  background: 0 0;
}
.private2022 .packageArea .packageBox .itemWrap .item_custom .food-info .dot_list.w100 li {
  width: 100%;
}
